...
function handleNewTaskButtonClick(taskTitle) {
    tasksBoardPresenter.handleAddNewTask(taskTitle); // Передаем введенный текст задачи в presenter
}
...
render(formAddTaskComponent, formContainer); // Передаем корректный экземпляр формы
